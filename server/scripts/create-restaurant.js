  ...
  try {
    const resultado = await provisionarRestaurante(
      pool,
      {
        ...
        senha: args.senha,
        mesas: args.mesas ?? 10,
        limite_mesas: args["limite-mesas"],
        limite_usuarios: args["limite-usuarios"],
        limite_produtos: args["limite-produtos"],
        mensalidade_centavos: args["mensalidade-centavos"],
        ciclo_cobranca: args["ciclo-cobranca"],
        status_cobranca: args["status-cobranca"],
        trial_termina_em: args["trial-termina-em"],
        proxima_cobranca_em: args["proxima-cobranca-em"],
        observacoes_plano: args["observacoes-plano"],
        plano: args.plano,
      },
